...
$rpFilters['serving_sizes'] = wp_dropdown_categories(array('selected' => $sizeSelected, 'hierarchical' => false, 'taxonomy' => 'recipe-serving', 'hide_empty' => false, 'name' => 'recipe_details[recipe_serving_size]', 'id' => 'recipe_serving_size', 'orderby' => 'name', 'echo' => false, 'show_option_none' => __('No Size', 'recipe-press')));
     ...
     <div class="details-minor">
          ...
          <?php if ( $this->options['use-times'] ) : ?>
               ...
               <div class="recipe-details recipe-details-cook-time">
                    <label for="recipe_cook_time"><?php _e('Cook Time', 'recipe-press'); ?></label>:
          ...
          <?php if ( $ready_time = get_post_meta($post->ID, '_recipe_ready_time_value', true) ) : ?>
                         <div class="recipe-details">
                              <label for="recipe_ready_time"><?php _e('Ready in', 'recipe-press'); ?></label>:
